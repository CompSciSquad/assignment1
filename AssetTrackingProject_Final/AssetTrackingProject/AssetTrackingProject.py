...
def select_user(event): # when user clicks on an entry in the data grid table the selected record is inputted into the 'add employee' boxes
    try:
        ...
        index = asset_tree_view.selection()[0]                
        selected_item = asset_tree_view.item(index)['values'] 
...
label_frame_AddData = LabelFrame(my_w_1, text='Add Employee',bg="lightcyan1")
...
label_frame_UpdateLabel = LabelFrame(my_w_1, text='Update Asset',bg="lightcyan1")
...
label_frame_DeleteLabel = LabelFrame(my_w_1, text='Delete Record',bg="lightcyan1")
...
label_frame_SearchGrid = LabelFrame(my_w_1, text='Search Record',bg="lightcyan1")
